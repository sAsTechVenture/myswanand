...
export default function RefundAndCancellationPolicy() {
  return (
    <PolicyLayout title="Return, Cancellation & Refund Policy">
      ...
      <p>
        At <strong>Swanand Pathology</strong>, we strive to deliver high-quality
        diagnostic and healthcare services. This Return, Cancellation & Refund
        Policy explains how cancellations, returns, and refunds are handled for
        services booked through our website or mobile application.
      </p>

      <p>
        Due to the nature of medical and diagnostic services, returns and refunds
        are subject to specific conditions as explained below.
      </p>
