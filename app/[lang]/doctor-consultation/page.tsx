...
function DoctorConsultationContent() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      ...
      if (searchQuery !== urlSearch) {
        ...
        params.set('page', '1');
        localizedRouter.push(`/doctor-consultation?${params.toString()}`);
      }
    }, 500);
  ...
  const handleBookAppointment = async () => {
    ...
    if (!isAuthenticated()) {
      localizedRouter.push('/auth/login?redirect=/doctor-consultation');
      return;
    }
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="p-4">
              <div className="relative">
                ...
                <Input
                  type="text"
                  placeholder={t('common.searchDoctorByName')}
                  value={searchQuery}
            ...
            {loading ? (
              ...
              <Card className="p-12 text-center">
                <p className="text-gray-600">{t('common.noDoctorsFound')}</p>
              </Card>
            ) : (
              <div className="space-y-4">
                {doctors.map((doctor) => {
