...
function DietitianConsultationContent() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      ...
      if (searchQuery !== urlSearch) {
        ...
        params.set('page', '1');
        router.push(`/dietitian-consultation?${params.toString()}`);
      }
    }, 500);
  ...
  const handleBookAppointment = async () => {
    if (!selectedDietitian || !selectedTimeSlot) {
      toast.error('Please select a dietitian and time slot.');
      return;
    }

    if (!isAuthenticated()) {
      router.push('/auth/login?redirect=/dietitian-consultation');
      return;
    }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="p-4">
              <div className="relative">
                ...
                <Input
                  type="text"
                  placeholder="Serach Doctor By Name and Specialty"
                  value={searchQuery}
            ...
            {loading ? (
              ...
              <Card className="p-12 text-center">
                <p className="text-gray-600">No dietitians found</p>
              </Card>
            ) : (
              <div className="space-y-4">
          ...
          <div className="lg:col-span-1">
            <Card className="p-6 sticky top-4">
              ...
              <div className="mb-6">
                ...
                {loadingSlots ? (
                  ...
                  <p className="text-sm text-gray-500 text-center py-4">
                    {!selectedDietitian
                      ? 'Please select a dietitian first'
                      : 'No slots available'}
                  </p>
                ) : (
                  <div className="space-y-4">
              ...
              >
                {booking ? 'Booking...' : 'Book Appoinment'}
              </Button>
